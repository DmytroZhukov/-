...
forklift1 = Forklift("Honda", "FP1", "Brown", 15000, 5)
crane1 = Crane("Caterpillar", "T300", "Yellow", 65000, 15)

print(car1.maker, car1.model, car1.colour, car1.price, car1.seats)
print(forklift1.maker, forklift1.model, forklift1.colour,
      forklift1.price, forklift1.lifting_weight)
print(crane1.maker, crane1.model, crane1.colour,
      crane1.price, crane1.lifting_weight)
